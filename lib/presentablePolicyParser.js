...
var literalNames = [ null, "':'", "','", "'in'", "'initial'", "'<initial>'", 
                     ...
                     "'end of'", "'at'", "'after'", "'of contract creation'", 
                     "'price priceExpression'", "'receiving transaction of'", 
                     "'to'", "'contract_guaranty of'", "'refund after'", 
                     "'receiving platform_guaranty of'", "'accepting license'", 
...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      null, null, null, null, null, null, null, null, null, 
                      "TIMEUNIT", "FOR", "SELF", "GROUPUSER", "REGISTERED_USERS", 
                      "PUBLIC", "TERMINATE", "ID", "MOBILEPHONE", "EMAIL", 
                      "FEATHERACCOUNT", "TWO_DIGITS", "HOUR", "INTEGER_NUMBER", 
                      "DATE", "ALPHANUMERIC", "NIGHT_DIGITS", "FOUR_DIGITS", 
                      "WS" ];
...
presentablePolicyParser.TIMEUNIT = 27;
presentablePolicyParser.FOR = 28;
presentablePolicyParser.SELF = 29;
presentablePolicyParser.GROUPUSER = 30;
presentablePolicyParser.REGISTERED_USERS = 31;
presentablePolicyParser.PUBLIC = 32;
presentablePolicyParser.TERMINATE = 33;
presentablePolicyParser.ID = 34;
presentablePolicyParser.MOBILEPHONE = 35;
presentablePolicyParser.EMAIL = 36;
presentablePolicyParser.FEATHERACCOUNT = 37;
presentablePolicyParser.TWO_DIGITS = 38;
presentablePolicyParser.HOUR = 39;
presentablePolicyParser.INTEGER_NUMBER = 40;
presentablePolicyParser.DATE = 41;
presentablePolicyParser.ALPHANUMERIC = 42;
presentablePolicyParser.NIGHT_DIGITS = 43;
presentablePolicyParser.FOUR_DIGITS = 44;
presentablePolicyParser.WS = 45;
...
presentablePolicyParser.prototype.segment = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(((((_la - 29)) & ~0x1f) == 0 && ((1 << (_la - 29)) & ((1 << (presentablePolicyParser.SELF - 29)) | (1 << (presentablePolicyParser.GROUPUSER - 29)) | (1 << (presentablePolicyParser.REGISTERED_USERS - 29)) | (1 << (presentablePolicyParser.PUBLIC - 29)) | (1 << (presentablePolicyParser.MOBILEPHONE - 29)) | (1 << (presentablePolicyParser.EMAIL - 29)))) !== 0));
        this.state = 68;
...
presentablePolicyParser.prototype.state_clause = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(_la===presentablePolicyParser.T__7 || _la===presentablePolicyParser.TERMINATE);
        this.state = 100;
        this._errHandler.sync(this);
...
presentablePolicyParser.prototype.initial_state_clause = function() {
    ...
    try {
        ...
        this.state = 104;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << presentablePolicyParser.T__3) | (1 << presentablePolicyParser.T__4) | (1 << presentablePolicyParser.T__5) | (1 << presentablePolicyParser.T__6))) !== 0))) {
...
presentablePolicyParser.prototype.target_clause = function() {
    ...
    try {
        ...
        case presentablePolicyParser.T__7:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while(_la===presentablePolicyParser.T__9) {
                this.state = 114;
                this.and_event();
                this.state = 119;
                this._errHandler.sync(this);
...
presentablePolicyParser.prototype.balance_event = function() {
    ...
    try {
        ...
        case presentablePolicyParser.T__23:
            ...
            break;
        case presentablePolicyParser.T__24:
            this.enterOuterAlt(localctx, 2);
            this.state = 196;
...
presentablePolicyParser.prototype.balance_smaller = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 202;
        this.match(presentablePolicyParser.T__24);
        this.state = 203;
        this.match(presentablePolicyParser.INTEGER_NUMBER);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
...
presentablePolicyParser.prototype.settlement_event = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 205;
        this.match(presentablePolicyParser.T__25);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
presentablePolicyParser.prototype.users = function() {
    ...
    try {
        ...
        this.state = 209;
        _la = this._input.LA(1);
        if(!(((((_la - 29)) & ~0x1f) == 0 && ((1 << (_la - 29)) & ((1 << (presentablePolicyParser.SELF - 29)) | (1 << (presentablePolicyParser.GROUPUSER - 29)) | (1 << (presentablePolicyParser.REGISTERED_USERS - 29)) | (1 << (presentablePolicyParser.PUBLIC - 29)) | (1 << (presentablePolicyParser.MOBILEPHONE - 29)) | (1 << (presentablePolicyParser.EMAIL - 29)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
