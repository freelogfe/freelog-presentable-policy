...
presentablePolicyParser.MOBILEPHONE = 36;
presentablePolicyParser.EMAIL = 37;
presentablePolicyParser.FEATHERACCOUNT = 38;
presentablePolicyParser.TWO_DIGITS = 39;
presentablePolicyParser.HOUR = 40;
presentablePolicyParser.INTEGER_NUMBER = 41;
presentablePolicyParser.DATE = 42;
presentablePolicyParser.ALPHANUMERIC = 43;
presentablePolicyParser.NIGHT_DIGITS = 44;
presentablePolicyParser.FOUR_DIGITS = 45;
...
presentablePolicyParser.RULE_time_unit = 27;
...
presentablePolicyParser.prototype.time_unit = function() {
    ...
    this.enterRule(localctx, 54, presentablePolicyParser.RULE_time_unit);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 207;
