...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      null, null, null, null, null, null, null, null, null, 
                      "GROUPNODE", "GROUPUSER", "FOR", "TERMINATE", "ID", 
                      "INTEGER_NUMBER", "USERACCOUNT", "FEATHERACCOUNT", 
                      "WS", "DATE" ];
...
presentable_policyParser.GROUPNODE = 27;
presentable_policyParser.GROUPUSER = 28;
presentable_policyParser.FOR = 29;
presentable_policyParser.TERMINATE = 30;
presentable_policyParser.ID = 31;
presentable_policyParser.INTEGER_NUMBER = 32;
presentable_policyParser.USERACCOUNT = 33;
presentable_policyParser.FEATHERACCOUNT = 34;
presentable_policyParser.WS = 35;
presentable_policyParser.DATE = 36;
...
presentable_policyParser.prototype.segment = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << presentable_policyParser.GROUPNODE) | (1 << presentable_policyParser.GROUPUSER) | (1 << presentable_policyParser.ID))) !== 0));
        this.state = 72;
...
UsersContext.prototype.GROUPNODE = function() {
    return this.getToken(presentable_policyParser.GROUPNODE, 0);
};
...
presentable_policyParser.prototype.users = function() {
    ...
    try {
        ...
        this.state = 203;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << presentable_policyParser.GROUPNODE) | (1 << presentable_policyParser.GROUPUSER) | (1 << presentable_policyParser.ID))) !== 0))) {
